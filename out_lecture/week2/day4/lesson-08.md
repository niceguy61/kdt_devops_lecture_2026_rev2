...
이 중 하나라도 없으면 Day 5 학습 정리 제출물에서 "Compose로 실행 가능"이라고 말하기 어렵다.
...
## Day 5 연결
Day 5에서는 Week 2 전체를 통합한다. Dockerfile은 image build 기준이고, Compose는 multi-container runtime 기준이다. 학습 정리 제출물에서는 다음 문장을 evidence로 뒷받침해야 한다.
