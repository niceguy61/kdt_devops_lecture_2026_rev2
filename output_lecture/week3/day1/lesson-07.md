...
## 수업 목표
- Compose 실행, 포트 충돌, 이미지 pull/build 문제 해결를 MSA 운영 문제로 설명한다.
...
![Week 3 Day 1 Lesson 7: 개인 면담 및 환경 점검](https://raw.githubusercontent.com/niceguy61/kdt_devops_lecture_2026_rev2/main/week3/day1/assets/lesson-07-environment-check.png)

이 이미지는 Week 3 Day 1 7교시 `개인 면담 및 환경 점검`의 핵심 개념을 세션 전용으로 시각화한 자료다. 다른 교시와 같은 그림을 재사용하지 않고, 이 세션에서 확인할 운영 evidence와 판단 기준에 맞춰 읽는다.

## Visual 1: 서비스 토폴로지 읽기
![Mermaid diagram 1](https://raw.githubusercontent.com/niceguy61/kdt_devops_lecture_2026_rev2/main/output_lecture/mermaid-assets/week3__day1__lesson-07--diagram-01.png)
...
## Visual 3: 장애 분석 흐름
![Mermaid diagram 2](https://raw.githubusercontent.com/niceguy61/kdt_devops_lecture_2026_rev2/main/output_lecture/mermaid-assets/week3__day1__lesson-07--diagram-02.png)
