...
## 시각 자료
![메시지 스트리밍과 AI 알림 요약](./assets/lesson-05-message-streaming-ai-alert.png)

![메시지 스트리밍 아키텍처 모델](./assets/lesson-05-streaming-architecture.png)

![메시지 스트리밍 최적화 포인트](./assets/lesson-05-streaming-optimization.png)
