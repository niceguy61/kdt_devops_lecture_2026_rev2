...
## 시각 자료
![프론트엔드 플랫폼과 AI 보조 개발](./assets/lesson-02-frontend-ai-workflow.png)

![프론트엔드 플랫폼 아키텍처 모델](./assets/lesson-02-frontend-architecture.png)

![프론트엔드 최적화 포인트](./assets/lesson-02-frontend-optimization.png)
