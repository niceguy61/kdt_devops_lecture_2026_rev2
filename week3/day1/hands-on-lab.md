# Week 3 Day 1 Hands-on Lab: MSA 운영 Evidence

## 목적
이 문서는 Day 1 교시별 실습을 하나의 실행 흐름으로 묶는다. 표준 실습 앱은 `week3/day1/labs/msa-demo`에 있으며, 모든 실습은 실행, 확인, 장애 재현, 복구, cleanup 기준을 남기는 방식으로 진행한다.
